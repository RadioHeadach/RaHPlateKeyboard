...
@interface NumLetterKeyboardView ()
@property(nonatomic, strong) UIButton *backSpaceBtn;/**< 退格键 */
@end

@implementation NumLetterKeyboardView
...
//                [btn setBackgroundImage:iPadKeyHighlightImage forState:UIControlStateHighlighted];
        ...
        [self.backBtn addTarget:self action:@selector(switchToHansKeyboard) forControlEvents:UIControlEventTouchUpInside];
...
- (void)switchToHansKeyboard
{
    if (self.onSwitchToHans) {
        self.onSwitchToHans();
    }
}
